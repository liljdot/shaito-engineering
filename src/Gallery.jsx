...
const webpackImages = require.context('./assets/images', false, /\.(png|jpe?g|svg)$/).keys().map(require.context("./assets/images", false, /\.(png|jpe?g|svg|gif|webp)$/))
                ...
                <div className="container">
                    ...
                    <div className="row mb-5 mb-md-5">
                        <div className="col-md-8 mx-auto" >
                            <BSCarousel images={webpackImages} sliderIndex={sliderIndex} changeSliderIndex={changeSliderIndex} />
                        </div>
                    </div>
