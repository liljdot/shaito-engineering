            ...
            <div className="service_page">
                ...
                <section className="about_section layout_padding">
                    <div className="container">
                        ...
                        <div className="row img-box">
                            <img src="images/ves-2.jpeg" alt="" className="col-md-6 mt-3 mt-md-3" />
                            <img src="images/ves-1.jpeg" alt="" className="col-md-6 mt-3 mt-md-3" />
                        </div>
                    </div>
                </section>
                <section className="professional_section about crane_section layout_padding">
                    <div className="container">
                        ...
                        <div className="row img-box">
                            <img src="images/aht.jpg" alt="" className="col-12 col-md-12 mt-3 mt-md-3" />
                        </div>
                    </div>
                    <div className="container">
                        <div className="row">
                        ...
                        <div className="row img-box">
                            <img src="images/crew-boat.jpg" alt="" className="col-12 col-md-12 mt-3 mt-md-3" />
                        </div>
                    </div>
                    <div className="container">
                        <div className="row">
                        ...
                        <div className="row img-box">
                            <img src="images/cargo.jpg" alt="" className="col-12 col-md-12 mt-3 mt-md-3" />
                        </div>
                    </div>
                </section>
                <section className="about_section layout_padding">
                    <div className="container clients">
                        ...
                        <div className="row img-box">
                            <img src="images/exxon.png" alt="" className="col-4 col-md-4 mt-3 mt-md-3" />
                            <img src="images/lng.png" alt="" className="col-4 col-md-4 mt-3 mt-md-3" />
                            <img src="images/total.png" alt="" className="col-4 col-md-4 mt-3 mt-md-3" />
                        </div>
                        <div className="row">
                            <div className="row generator-brand">
                                <div className="col">
